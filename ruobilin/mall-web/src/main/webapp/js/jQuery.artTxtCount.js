...
(function($){
	...
	$.fn.artTxtCount = function(tipWrap, maxNumber){
		...
		var count = function(){
			...
			$(".commentsPublishBtn").css({'background-color':"#336699"}).attr("disabled",　false);;	
			...
			this.animate( { color:'#FFFFFF' }, 200 );
   			this.animate( { color:'#FF0000' }, 200 );
			$(".commentsPublishBtn").css({'background-color':"#ccc"}).attr("disabled",　true);
			}
		...
		$(this).bind('input propertychange', count);
