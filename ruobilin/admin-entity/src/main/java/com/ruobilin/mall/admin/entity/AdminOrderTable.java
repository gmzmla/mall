...
/**
 * 订单表：订单编号、总计、订单状态、用户ID、收货人、收货人地址、手机号码、支付方式、运费、送货日期、配送时间、发票类型、发票抬头、发票内容、快递公司、快递单号
 */
public class AdminOrderTable {
	...
	private List<AdminListOfGoods> listOfGoodsList;
	...
	public List<AdminListOfGoods> getListOfGoodsList() {
		return listOfGoodsList;
	}
	public void setListOfGoodsList(List<AdminListOfGoods> listOfGoodsList) {
